        ...
        <div className={styles.individualTiersContainer}>
            <div className={styles.tierContainer}>
                ...
                <div style={{bottom:'4vh'}}>
                    <span className={styles.subHeading} style={{fontSize:'10px', fontWeight:'300', opacity: '40%'}}>* Prices may vary depending on vehicle model.</span>
                </div>
            </div>
