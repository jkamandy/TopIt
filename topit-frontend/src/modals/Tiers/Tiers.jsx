    ...
    <div className={styles.tiersContainer}>
        ...
        <div className={styles.individualTiersContainer}>
            <div className={styles.tierContainer}>
                ...
                <br/>
                <span className={styles.subHeading} style={{fontSize:'1vw', fontWeight:'300'}}>STARTING AT <span className={styles.subHeadingRedU} style={{fontSize:'5.3vw'}}>$100</span></span>
